...
int main(void)
{
    ...
    vector<int> fib(elem_vals, elem_vals+3);
    ...
    vector<int> pent(elem_vals+15, elem_vals+18);

    vector<int> * seq_addrs[max_seq] ={
        &fib, &lucas, &pell, &triangular, &square, &pent
    };

    vector<int> * cur_vec(nullptr);
    int seq_index = 0;
    int cur_tuple = 0;
